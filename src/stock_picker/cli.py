...
from stock_picker.cli_commands.dispatch import execute_command as execute_domain_command
...
def execute_command(args: argparse.Namespace, context: CliContext):
    dispatched = execute_domain_command(
        args,
        context,
        progress_logger_factory=_configure_progress_logger,
        json_event_printer=_json_event_printer,
    )
