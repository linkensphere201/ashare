...
The worker keeps a small local upload-state file under the reports directory so repeated checks do not upload the same `trade_date` and `bundle_hash` again.
